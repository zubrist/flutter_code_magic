              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    // Navigate and THEN dispose when the route is removed
  ...
  void _startCountdown() {
    ...
    _countdownTimer = Timer.periodic(const Duration(seconds: 1), (timer) {
      ...
      if (_countdown > 0) {
        ...
        // Show recharge bottom sheet when 5 seconds remain
        if (_countdown == 5) {
          ...
          actions: [
            ElevatedButton(
              ...
              onPressed: () {
                ...
                _navigateToHomeScreen(); // Implement this function to go home
              },
              child: Text(
                'OK',
                style: GoogleFonts.poppins(fontWeight: FontWeight.w600),
